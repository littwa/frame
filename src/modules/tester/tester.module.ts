...
const useFactoryTest = {
  ...
  useFactory: async (configServiceTest: ConfigServiceTest, configService: ConfigService) => {
...
@Module({
  ...
  providers: [TesterService, TesterAService, TesterBService, ConfigServiceTest, useFactoryTest, useClassTest, CommonService],
